...
- "load-bearing" — a classic AI phrase. Flag every instance without exception. Describe what the claim or variable actually does in the argument rather than labeling it "load-bearing."
