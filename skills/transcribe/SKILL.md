...
/transcribe doe_jane/DOEJANE_15Jan2026.m4a
```
...
Update the project's contact-network memory file (e.g., `.workspace/memory/contact_network.md`) if new contacts were mentioned.
